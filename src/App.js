...
function App(props) {
  ...
  const [formData, setFormData] = useState({
    isRVParkingAllowed: "yes",
    isOvernightLocation: "yes",
    isOvernightParking: "yes",
    isOvernightParkingEnforced: "yes",
    isInfoCorrect: "yes",
              ...
              <div className="mt-30 space-between">
                <div>
                  <HeadingType
                    variant="body"
                    required="true"
                    text="Is overnight RV Parking allowed?"
                  />
                </div>
                <div>
                  <ToggleButton
              ...
              <div className="mt-30 space-between">
                <div>
                  <HeadingType
                    variant="body"
                    required="true"
                    text="Did you stay overnight at this location?"
                  />
                </div>
                <div>
                  <ToggleButton
              ...
              <div className="mt-30 space-between">
                <div>
                  <HeadingType
                    variant="body"
                    required="true"
                    text="Did you confirm the overnight RV Parking policy?"
                  />
                </div>
                <div>
                  <ToggleButton
                    ...
                    <div className="mt-30">
                      <div>
                        <HeadingType
                          variant="body"
                          required="true"
                          text="When did you confirm the policy?"
                        />
                      </div>
                      <div className="ml-6 mr-6">
                        <Grid xs={12} sm={6}>
